...
@section('content')
    ...
    <div class="bm-card" style="max-width:660px">
        ...
        <form method="post" action="{{ route('banimark.admin.license.save') }}">
            ...
            <label>HQ endpoint <span class="muted">(leave blank unless support says otherwise)</span></label>
            <input type="text" name="hq_url" value="{{ $hqUrl }}" placeholder="{{ \Banimark\Licensing\Master::DEFAULT_ENDPOINT }}">
