...
class Html
{
    ...
    {
        return '<!doctype html><html lang="en"><head>'.Layout::head('Banimark - '.$title).'</head><body>'
            .'<div class="bm-auth">'.Layout::authArt().'<div class="auth-main"><div class="box">'.$content.'</div></div></div>'
    ...
    {
        return self::bare('Sign in', '<div class="bm-card">'
    ...
    public static function activate(string $action, string $loginUrl, ?array $agent, string $error = ''): string
    {
        ...
        return self::bare('Activate your account', '<div class="bm-card">'
    ...
    {
        return self::bare('Verify', '<div class="bm-card">'
